...
/**
 * Canonical split-screen payload model (JSON-serializable via Jackson).
 */
public class SplitScreenModel {
    ...
    public SplitScreenModel(String uniqueId, String layoutMode,
                              String contentId1, String contentId2,
                              List<Content> zone1, List<Content> zone2) {
